...
<body class="inside-page">
	...
	<div id="main-content">
		<div class="module">
		Recommendation System -  Personalize Content Discovery

		Recommends content, tailored specifically to the tastes and preferences of individual users.  Imagine 
		...
		your leads?  It’s the same math.  Simply put, the scoring system assign a value to your data based on an 
		...
		Forget keywords.  If you can assign topics to documents dynamically, then you don’t need to have a list of 
		categories a priori.  What’s more, if two topics are too closely, cognitively, related, we can identify 
