...
<head>
	...
	<link rel="stylesheet" type="text/css" href="styles/pages/services.css">
</head>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8 col-sm-offset-2">
					<div class="col-sm-3 header-image">
					...
					<div class="col-sm-12 content">
						<div>
							<h1>Services</h1>
							<p>Serial Metrics ensures that companies efficiently solve Machine Learning challenges. Our
							consulting services cover three basic areas:</p>
						</div>
				...
				<div class="col-sm-8 col-sm-offset-2">
					<div class="col-sm-12 content">
						<div>
							...
							<p>Serial Metrics offers sets of APIs that use your data. We leverage cutting edge machine learning techniques
							   to solve your company&lsquo;s most complex problems.</p>
						</div>

						<div>
							<h2>Methodology</h2>
							<h3>Our services cover the full stack</h3>
